...
##----------------------------------------------------------------------------------------------------------------------------------------------------
	...
	time_remaining = np.where(df_spec_game['After_Skipped_Time_Remaining']>-1, df_spec_game['After_Skipped_Time_Remaining'], df_spec_game['After_Skipped_Time_Remaining'])
	winning_team = np.where(df_spec_game['After_Skipped_Time_Remaining']>-1, df_spec_game['Winner'], df_spec_game['Winner'])
